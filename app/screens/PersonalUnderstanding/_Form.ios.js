      ...
      <View>
        <View style={mainStyles.instructionContainer}>
          ...
          <Text style={{flex: 1}}>
            ...
            ករណីសិស្សទទួលបាន ពិន្ទុក្រោម ៥០% សិស្សត្រូវធ្វើតេស្តឡើងវិញម្តងទៀត មុននឹងឈានទៅវគ្គបន្ទាប់។
          </Text>
        </View>

        <Text style={mainStyles.instructionText}>ចូរបំពេញចម្លើយខាងក្រោម៖</Text>
      </View>
