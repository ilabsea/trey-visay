const HomeOptions = [
  {
    ...
    description: 'ធ្វើតេស្តមុខរបរ ឬអាជីពដោយផ្អែកលើបុគ្គលិកលក្ខណៈដើម្បី ជ្រើសរើសមុខរបរសាកសមនឹងអ្នក'
  },
  {
  ...
  },
  {
    ...
    button_text: 'ពិស្តារ',
    description: 'អំពីពត៌មានគ្រឹះស្ថានសិក្សា អាស័យដ្ឋានទំនាក់ទំនង និងមុខវិជ្ជាសិក្សាក្រោយបញ្ចប់ថ្នាក់ទី១២'
  },
  {
    ...
    button_text: 'ពិស្តារ',
    description: 'សំរាប់អ្នកគ្មានលទ្ធភាពបន្តការសិក្សា បរិញ្ញាប័ត្រ អ្នកអាចរៀនជំនាញវិជ្ជា ជីវៈរយៈពេលខ្លី'
  },
  {
    title: ' វីដេអូមុខរបរ',
    url: 'VideoScreen',
